...
public sealed class GameStateManager : StateManager
{
    ...
    protected override Dictionary<StateTransition, StateTransitionOutput> Transitions => new()
    {
        ...
        { new(GameState.BeforeRoll, ActionType.PlayRoadBuildingCard), new(GameState.RoadBuilding, StateTransitionType.Add) },
        ...
        { new(GameState.AfterRoll, ActionType.PlayRoadBuildingCard), new(GameState.RoadBuilding, StateTransitionType.Add) },
        ...
        { new(GameState.RoadBuilding, ActionType.BuildRoad), new(GameState.RoadBuilding) },
        { new(GameState.RoadBuilding, ActionType.FinishRoadBuilding), new(GameState.RoadBuilding, StateTransitionType.Remove) }
    };
}
