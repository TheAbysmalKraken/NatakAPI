...
internal sealed class PlayWealthCardCommandHandler(
    IActiveGameCache cache)
    : ICommandHandler<PlayWealthCardCommand>
{
    public async Task<Result> Handle(
        PlayWealthCardCommand request,
        CancellationToken cancellationToken)
    {
        ...
        var playCardResult = game.PlayWealthCard(
